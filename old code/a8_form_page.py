...
class A8FormPage(QWidget):
    """Page for completing MHA Form A8 - Section 3 Single Medical Recommendation for Treatment."""
    ...
    def _setup_ui(self):
        ...
        title = QLabel("Form A8 — Section 3 Medical Recommendation for Treatment")
        ...
        self._create_section_5_appropriate_treatment()
    ...
    # ----------------------------------------------------------------
    # SECTION 5: Appropriate Treatment
    # ----------------------------------------------------------------
    def _create_section_5_appropriate_treatment(self):
        frame = self._create_section_frame(5, "Appropriate Treatment")
        layout = frame.layout()
    ...
    def _export_docx(self):
        ...
        try:
            ...
            template_path = os.path.join(os.path.dirname(__file__), 'templates', 'Form_A8_template.docx')
            ...
            # Hospital for treatment - goes in para 29 (whitespace below instruction)
