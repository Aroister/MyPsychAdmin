...
class MyPsyRichTextEditor(QTextEdit):
    ...
    def set_font_size(self, size: int):
        print(f"[DEBUG] set_font_size -> {size}")  # debug
    ...
    def set_font_family(self, family: str):
        print(f"[DEBUG] set_font_family -> {family}")  # debug
        cursor = self.textCursor()
        if not cursor:
            return
        fmt = cursor.charFormat()
    ...
    def toggle_italic(self):
        print("[DEBUG] toggle_italic")  # debug
        self._toggle_char_flag("fontItalic")

    def toggle_underline(self):
        print("[DEBUG] toggle_underline")  # debug
    ...
    def set_text_color(self, color):
        print(f"[DEBUG] set_text_color -> {color}")  # debug
        cursor = self.textCursor()
        if not cursor:
            return
        fmt = cursor.charFormat()
    ...
    def set_highlight_color(self, color):
        print(f"[DEBUG] set_highlight_color -> {color}")  # debug
        cursor = self.textCursor()
        if not cursor:
            return
        fmt = cursor.charFormat()
